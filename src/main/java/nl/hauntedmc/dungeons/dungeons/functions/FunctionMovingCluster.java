...
import nl.hauntedmc.dungeons.api.blocks.MovingBlockCluster;
...
public class FunctionMovingCluster extends FunctionMovingBlock {
   @SavedField
   private final List<Location> blockLocs = new ArrayList<>();
   ...
   public void buildHotbarMenu() {
      ...
      this.menu.addMenuItem(new MenuItem() {
         ...
         public void onSelect(PlayerEvent event) {
            ...
            if (block == null) {
               player.sendMessage(Dungeons.logPrefix + HelperUtils.colorize("&aSet first corner to your position."));
               FunctionMovingCluster.this.pos1 = player.getLocation().toBlockLocation();
            } else {
               player.sendMessage(Dungeons.logPrefix + HelperUtils.colorize("&aSet first corner to target block."));
            ...
            if (FunctionMovingCluster.this.pos2 != null) {
               ...
               player.sendMessage(Dungeons.logPrefix + HelperUtils.colorize("&bAdded blocks in selected area!"));
            }
         }
         ...
         public void onClick(PlayerEvent event) {
            ...
            if (block == null) {
               ...
               player.sendMessage(Dungeons.logPrefix + HelperUtils.colorize("&aSet second corner to your position."));
            } else {
               player.sendMessage(Dungeons.logPrefix + HelperUtils.colorize("&aSet second corner to target block."));
      ...
      this.menu.addMenuItem(new MenuItem() {
         ...
         public void onSelect(PlayerEvent event) {
            ...
            if (FunctionMovingCluster.this.pos2 != null) {
               ...
               player.sendMessage(Dungeons.logPrefix + HelperUtils.colorize("&bRemoved blocks in selected area!"));
            }
         }
