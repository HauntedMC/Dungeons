      ...
      this.menu.addMenuItem(new ToggleMenuItem() {
         ...
         public void onSelect(Player player) {
            if (!FunctionAllowBlock.this.allowPlace) {
               player.sendMessage(HelperUtils.colorize(Dungeons.logPrefix + "&aSwitched to '&6Placing Blocks Allowed&a'"));
            } else {
               player.sendMessage(HelperUtils.colorize(Dungeons.logPrefix + "&aSwitched to '&6Deny Placing Blocks&a'"));
            }
      ...
      this.menu.addMenuItem(new ToggleMenuItem() {
         ...
         public void onSelect(Player player) {
            if (!FunctionAllowBlock.this.allowBreak) {
               player.sendMessage(HelperUtils.colorize(Dungeons.logPrefix + "&aSwitched to '&6Breaking Blocks Allowed&a'"));
            } else {
               player.sendMessage(HelperUtils.colorize(Dungeons.logPrefix + "&aSwitched to '&6Deny Breaking Blocks&a'"));
            }
      ...
      this.menu.addMenuItem(new ToggleMenuItem() {
         ...
         public void onSelect(Player player) {
            if (!FunctionAllowBlock.this.allowBucket) {
               player.sendMessage(HelperUtils.colorize(Dungeons.logPrefix + "&aSwitched to '&6Using Buckets Allowed&a'"));
            } else {
               player.sendMessage(HelperUtils.colorize(Dungeons.logPrefix + "&aSwitched to '&6Deny Using Buckets&a'"));
            }
