            ...
            switch (this.inputType) {
               ...
               case PASSWORD:
                  if (message.equalsIgnoreCase("none")) {
                     ...
                     MythicDungeons.inst().getListingManager().putListing(player, this.build());
                     this.dispose();
                     return;
                  }
                  ...
                  LangUtils.sendMessage(player, "commands.recruit.setup.complete");
                  player.playSound(player.getLocation(), "entity.player.levelup", 1.0F, 1.0F);
                  Bukkit.getScheduler().runTask(MythicDungeons.inst(), () -> MythicDungeons.inst().getListingManager().putListing(player, this.build()));
                  this.dispose();
            }
         }
      }
