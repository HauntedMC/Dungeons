...
public class HasDungeonCooldownCondition implements IEntityCondition {
   private final String dungeon;

   public HasDungeonCooldownCondition(MythicLineConfig mlc) {
   ...
   public boolean check(AbstractEntity target) {
      if (!target.isPlayer()) {
         ...
         if (dungeon == null) {
            ...
            return dungeon.hasAccessCooldown(player);
         }
      }
   }
}
