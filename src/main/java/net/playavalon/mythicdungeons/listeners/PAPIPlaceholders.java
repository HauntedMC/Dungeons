...
public class PAPIPlaceholders extends PlaceholderExpansion {
   ...
   public PAPIPlaceholders(MythicDungeons plugin) {
      this.plugin = plugin;
   }
   ...
   public String onRequest(OfflinePlayer oPlayer, String params) {
      ...
      if (oPlayer != null) {
         mPlayer = MythicDungeons.inst().getMythicPlayer(oPlayer.getUniqueId());
      }
      ...
      if (params.contains("dungeon")) {
         ...
         AbstractDungeon dungeon = MythicDungeons.inst().getDungeons().get(targetDungeonName);
         if (dungeon != null) {
      ...
      if (params.contains("party")) {
         ...
         if (MythicDungeons.inst().isThirdPartyProvider()) {
            if (party == null) {
               party = new PartyWrapper(mPlayer);
            }
