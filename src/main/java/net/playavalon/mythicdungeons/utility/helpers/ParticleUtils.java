...
public final class ParticleUtils {
   ...
   public static void displayBoundingBox(final Player to, int ticks, final Particle particle, final BoundingBox... boxes) {
      ...
      ticker.runTaskTimer(MythicDungeons.inst(), 0L, 10L);
      Bukkit.getScheduler().runTaskLater(MythicDungeons.inst(), ticker::cancel, ticks);
   }
   ...
   public static void displayStructureBox(Player to, BoundingBox... boxes) {
      if (MythicDungeons.inst().isPaperSupport() || ServerVersion.get().isAfterOrEqual(ServerVersion.v1_20_4)) {
