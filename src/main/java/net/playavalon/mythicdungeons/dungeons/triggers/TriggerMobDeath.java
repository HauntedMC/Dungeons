   ...
   public void buildHotbarMenu() {
      this.menu.addMenuItem(new ChatMenuItem() {
         ...
         public void onSelect(Player player) {
            ...
            player.sendMessage(Util.colorize(MythicDungeons.debugPrefix + "&eMob is currently: &6" + TriggerMobDeath.this.mob));
         }
      ...
      this.menu.addMenuItem(new ChatMenuItem() {
         ...
         public void onInput(Player player, String message) {
            ...
            if (value.isPresent()) {
               player.sendMessage(Util.colorize(MythicDungeons.debugPrefix + "&aSet amount to '&6" + TriggerMobDeath.this.count + "&a'"));
            }
         }
      });
      ...
      this.menu.addMenuItem(new ChatMenuItem() {
         ...
         public void onSelect(Player player) {
            ...
            player.sendMessage(Util.colorize(MythicDungeons.debugPrefix + "&eCurrent radius: &6" + TriggerMobDeath.this.radius));
         }
         ...
         public void onInput(Player player, String message) {
            ...
            if (value.isPresent()) {
               player.sendMessage(Util.colorize(MythicDungeons.debugPrefix + "&aSet radius to '&6" + TriggerMobDeath.this.radius + "&a'"));
            }
         }
      });
